...
open class Literals {
    ...
    static var btnInvitedTitle = "Únete mas tarde"
    static var btnRegistryTitle = "Únete!"
    static var btnRecoveryTitle = "Olvide mi contraseña"
    static var btnContinueTitle = "Entrar"
